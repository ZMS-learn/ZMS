module da_setup_structures
   ...
   use da_control, only : trace_use,vert_evalue,stdout,rootproc, myproc, &
      ...
      max_vert_var11, max_vert_var12, max_vert_var_alpha, &                                          ! zhengh,20221015
      ...
      var_scaling12,&                                           ! zhengh,20221015
      remain_regcoeff1, remain_regcoeff2, remain_regcoeff3, remain_regcoeff4, remain_regcoeff5, &
      remain_regcoeff6, remain_regcoeff7, remain_regcoeff8, remain_regcoeff9, remain_regcoeff10, remain_regcoeff11, &       !remain_regcoeff,Zheng,20200924
      remain_regcoeff12, &                                           ! zhengh,20221015
      ...
      cv_options, use_regcoeff, cloud_cv_options, cv_size, as1, as2, as3, as4, as5, print_detail_be, &                          !use_regcoeff,Zheng,20200518
      qnr_option, &                                                                                 ! zhengh,20221015
      ids,ide,jds,jde,kds,kde, ims,ime,jms,jme,kms,kme, &
      its,ite,jts,jte,kts,kte, ips,ipe,jps,jpe,kps,kpe, root, comm, ierr, &
      fmt_info, fmt_srfc, fmt_each, unit_end, max_ext_its, &  
      u_v_factor, u_t_factor, u_ps_factor, u_rh_factor, &
      u_qcloud_factor, u_qice_factor, u_qrain_factor, u_qsnow_factor, u_qgraup_factor, &
      psi_chi_factor, psi_t_factor, psi_ps_factor, psi_rh_factor, &
      psi_qcloud_factor, psi_qice_factor, psi_qrain_factor, psi_qsnow_factor, psi_qgraup_factor, &
      v_u_t_factor, v_u_ps_factor,v_u_rh_factor, &
      v_u_qcloud_factor, v_u_qice_factor, v_u_qrain_factor, v_u_qsnow_factor, v_u_qgraup_factor, &
      chi_u_t_factor, chi_u_ps_factor,chi_u_rh_factor, &
      chi_u_qcloud_factor, chi_u_qice_factor, chi_u_qrain_factor, chi_u_qsnow_factor, chi_u_qgraup_factor, &
      t_u_ps_factor, t_u_rh_factor, &
      t_u_qcloud_factor, t_u_qice_factor, t_u_qrain_factor, t_u_qsnow_factor, t_u_qgraup_factor, &
      ps_u_rh_factor, ps_u_qcloud_factor, ps_u_qice_factor, ps_u_qrain_factor, ps_u_qsnow_factor, ps_u_qgraup_factor, &
      rh_u_qcloud_factor, rh_u_qice_factor, rh_u_qrain_factor, rh_u_qsnow_factor, rh_u_qgraup_factor, &
      qcloud_u_qice_factor, qcloud_u_qrain_factor, qcloud_u_qsnow_factor, qcloud_u_qgraup_factor, &
      qice_u_qrain_factor, qice_u_qsnow_factor, qice_u_qgraup_factor, &
      qrain_u_qsnow_factor, qrain_u_qgraup_factor, &
      qsnow_u_qgraup_factor, &                                                                                                  !factors,Zheng,20200518
      psi_qnrain_factor,chi_u_qnrain_factor,t_u_qnrain_factor,ps_u_qnrain_factor,rh_u_qnrain_factor,&                           !factors,Zhengh,20221015
      qcloud_u_qnrain_factor,qice_u_qnrain_factor,qrain_u_qnrain_factor,qsnow_u_qnrain_factor,qgraup_u_qnrain_factor,&          !factors,Zhengh,20221015
      u_qnrain_factor,v_u_qnrain_factor,&                                                                                       !!factors,Zhengh,20221015
